...
public class MainActivity extends  TabActivity  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TabSpec tabSpec1 = tabHost.newTabSpec("TAG1").setIndicator("영화 후기");
        tabSpec1.setContent(new Intent(this, movielist.class));
        ...
        tabSpec4.setContent(new Intent(this, MovieBoardActivity.class));
